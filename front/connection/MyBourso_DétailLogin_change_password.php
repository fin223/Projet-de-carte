<?php   
    ...
    require_once 'MyBourso_DétailLogin_config.php';
    ...
    if(!empty($_POST['current_password']) && !empty($_POST['new_password']) && !empty($_POST['new_password_retype'])){
        ...
        if(password_verify($current_password, $data_password['password']))
        {
            ...
            if($new_password === $new_password_retype){
                ...
                // On redirige
                header('Location: MyBourso_DétailLogin_landing.php?err=success_password');
                die();
            }
        }
        else{
            header('Location: MyBourso_DétailLogin_landing.php?err=current_password');
            die();
        }

    }
    else{
        header('Location: MyBourso_DétailLogin_landing.php');
        die();
    }
