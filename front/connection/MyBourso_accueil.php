<?php 
    session_start();
    require_once 'MyBourso_DétailLogin_config.php'; // ajout connexion bdd 
    
   // si la session existe pas soit si l'on est pas connecté on redirige
    if(!isset($_SESSION['user'])){
        header('Location:MyBourso_DétailLogin_index.php');
        die();
    }
...
<html lang="en">
  ...
  <body>
    ...
    <div class="text-center">
        ...
        <?php echo require 'MyBourso_Accueil_Prototype.php'; ?>
            <hr />
                <a href="MyBourso_DétailLogin_deconnexion.php" class="btn btn-danger btn-lg">Déconnexion</a>
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title">Changer mon mot de passe</h5>
                            ...
                            <div class="modal-body">
                                <form action="MyBourso_DétailLogin_change_password.php" method="POST">
